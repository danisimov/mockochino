...
public class MockHandlerTest extends UUIDTestBase {
    ...
    @Test
    public void getTest() {
        JsonNode responseMsg = target.path("mock/" + uuid).request().get(JsonNode.class);
    ...
    @Test
    public void putTest() {
        JsonNode responseMsg = target.path("mock/" + uuid).request().put(Entity.text("test"), JsonNode.class);
        System.out.println(responseMsg);
        Asserts.verifyBoolean(responseMsg, Const.RESULT, true);
        Asserts.verifyString(responseMsg, Const.MESSAGE, Const.ECHO);
    }
    ...
    public void deleteTest() {
        JsonNode responseMsg = target.path("mock/" + uuid).request().delete(JsonNode.class);
        System.out.println(responseMsg);
        Asserts.verifyBoolean(responseMsg, Const.RESULT, true);
        Asserts.verifyString(responseMsg, Const.MESSAGE, Const.ECHO);
    }
    ...
    public void authTest() {
        ...
        responseMsg = target.path("mock/" + uuid).request().header("Authorization", token).get(JsonNode.class);
        System.out.println(responseMsg);
        Asserts.verifyBoolean(responseMsg, Const.RESULT, true);
        Asserts.verifyString(responseMsg, Const.MESSAGE, Const.ECHO);
    }
